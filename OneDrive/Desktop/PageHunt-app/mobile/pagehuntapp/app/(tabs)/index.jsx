...
// sleep for ms getting an promise 
...
export default function Home() {
    ...
    const [hasMore , setHasMore] = useState(true);
     ...
     {/* handling the loading more books */}
    ...
    const renderItem = ({item}) => (
       <View style={styles.bookCard}>
        ...
        <View style={styles.bookDetails}>
           <Text style={styles.bookTitle}> {item.title}
            </Text>
    ...
    { /* rendering the stars on the screen */}
    ...
    const renderRatingStars = (rating) => {
      ...
      {/* using flatlist to show large amount of data on the screen */}
            ...
            //  {/* this threshold (trigger) it triggers when the 10% away from end , this threshold ranges from 0.1 to 0.5 (10% to 50%) */}
             ...
             ListHeaderComponent={
               <View style={styles.header}>
                <Text style={styles.headerTitle}>PageHunt</Text>
                <Text style={styles.headerSubtitle}>Discover some great books</Text>
              </View>
             }
             ListFooterComponent={
